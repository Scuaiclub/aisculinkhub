...
const ThreadsIcon = (props: any) => (
    <svg role="img" viewBox="0 0 24 24" fill="currentColor" width="24" height="24" xmlns="http://www.w3.org/2000/svg" {...props}>
        <title>Threads</title>
...
export const CONFIG: AppConfig = {
    ...
    socials: [
        ...
        { label: "Threads", url: "https://www.threads.com/@ai.scu.club", icon: ThreadsIcon },
    ...
    links: [
        ...
        { text: "社員報名", url: "https://docs.google.com/forms/d/e/1FAIpQLSdFLPyroyQrgVWbKb_PprHImDGg0oek8_hq5wEUblCvteJ1sQ/viewform?fbclid=PAZnRzaAQqNGlleHRuA2FlbQIxMQBzcnRjBmFwcF9pZA8xMjQwMjQ1NzQyODc0MTQAAae0TUtRPb4PFNRiH87yF3FrCm4ezkEXpjeX5ixOyJwj8h-5hRIpBod2ctKCkw_aem_yKSQrbzoBNSOyPJusk40Cg", icon: UserCog },
